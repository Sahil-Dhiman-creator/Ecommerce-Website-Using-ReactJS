...
[
    {
        id: 1,
        img: Image1,
        title: "Up to 50% off on all Men's Wrar",
        description:
        "Get the best deals on Men's Wear this season. Up to 50% off on all Men's Wrar",
    },
    {
        id: 2,
        img: Image2,
        ...
        description:
        "Get the best deals on Women's Wear this season. Up to 30% off on all Women's Wrar",
    },
    {
        id: 3,
        img: Image3,
        ...
        description:
        "Get the best deals on all Products this season. 70% off on all Products Sale",
    },
];
const Hero = ({handleOrderPopup}) => {
  ...
  return (
    ...
    className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 
              flex justify-center items-center dark:bg-slate-950 dark:text-white 
              duration-300'>
        <div 
                    ...
                    <div>
                        <div className='grid grid-cols-1 sm:grid-cols-2'>
                            <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center
                                ...
                                <p data-aos="fad-up" data-aos-duration="500" data-aos-delay="100"
                                className='text-sm'>
                                    {data.description}
                                </p>
